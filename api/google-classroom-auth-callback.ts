...
export default async function handler(
  ...
  const successUrl = `${base}${returnTo.startsWith('/') ? returnTo : `/${returnTo}`}?google_classroom=connected`;
  const errorUrl = `${base}${returnTo.startsWith('/') ? returnTo : `/${returnTo}`}?google_classroom=error`;
